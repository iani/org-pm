...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "<f13> m") 'org-pm-menu)
  (global-set-key (kbd "H-e f") 'org-pm-publish-file)
  (global-set-key (kbd "<f13> f") 'org-pm-publish-file)
  (global-set-key (kbd "H-e s") 'org-pm-publish-subtree)
  (global-set-key (kbd "<f13> s") 'org-pm-publish-subtree)
